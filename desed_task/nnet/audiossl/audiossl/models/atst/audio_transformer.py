...
def AST_small(**kwargs):
    print("AST: Small")
    return AST(embed_dim=384, depth=12, num_heads=6, qkv_bias=False, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)


def AST_base(**kwargs):
    print("AST: Base")
    return AST(embed_dim=768, depth=12, num_heads=12, qkv_bias=False, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)


def AST_large(**kwargs):
    return AST(embed_dim=1024, depth=24, num_heads=16,qkv_bias=False, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
